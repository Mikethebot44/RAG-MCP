...
export class DeleteSourceTool {
   ...
   */
  async execute(input: DeleteSourceInput): Promise<{
    success: boolean;
    message: string;
   ...
   */
  private async deleteSourceByUrl(sourceUrl: string, startTime: number): Promise<{
    success: boolean;
    message: string;
    deletedChunks?: number;
    sourceUrl?: string;
   ...
   * Find source by ID
   */
  private async findSourceById(sourceId: string): Promise<{ id: string; url: string; title: string } | null> {
    try {
   ...
   */
  private async findSourceByUrl(url: string): Promise<{ id: string; url: string; title: string } | null> {
    try {
   ...
   */
  async deleteMultipleSources(sourceIds: string[]): Promise<{
    success: boolean;
    message: string;
    results: Array<{
      sourceId: string;
   ...
   */
  async deleteAllSources(confirmationPhrase: string): Promise<{
    success: boolean;
    message: string;
   ...
   */
  async previewDeletion(sourceId: string): Promise<{
    success: boolean;
    message: string;
    sourceInfo?: {
      id: string;
